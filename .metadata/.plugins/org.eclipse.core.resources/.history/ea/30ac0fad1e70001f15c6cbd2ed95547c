...
public void i_login_with_valid_credentials() {
	...
	driver.findElement(By.xpath("//input[@data-qa='login-email']")).sendKeys("vpmutkure@gmail.com");
	driver.findElement(By.xpath("//input[@placeholder='Password']")).sendKeys("V@12345m");
